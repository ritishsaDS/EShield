...
class _ServiceTabState extends State<StoreScreen>
  ...
  getProductCategory() async {
    try {
      ...
      final response = await client.post(baseUrl() + "get_all_product_category",
  ...
  getProduct(String id) async {
    try {
      ...
      final response = await client.post(baseUrl() + "get_pro_by_cat_id",
          headers: headers, body: map);
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Container(
                                          height: 120,
                                          width: 140,
                                          child: Image.network(productModal
